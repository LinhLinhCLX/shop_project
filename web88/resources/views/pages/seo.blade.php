    ...
    <div class="content">
        ...
        <center>
            ...
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link"javascript:void(0);">2</a></li>

                <li class="page-item"><a class="page-link"javascript:void(0);">3</a></li>

                <li class="page-item"><a class="page-link"javascript:void(0);">4</a></li>
