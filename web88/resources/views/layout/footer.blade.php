        ...
        <div class="container pt-4" style="padding-bottom: 2rem;">
            <div class="row">
                <div class="info-contact col-md-4">
                    ...
                    <div class="text-center"><img src="{{ asset('image/contact-forms-7.png')}}" alt=""></div>
                </div>
                <div class="col-md-8">
                    ...
                    <form id="dk_form" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="w_name" id="dk_name" placeholder="Tên của bạn" required>
                            <input type="hidden" name="w_id" id="dk_id">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Địa chỉ *</label><br>
                            <input type="text" name="w_address" class="form-control" id="dk_address" aria-describedby="emailHelp" placeholder="Địa chỉ" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Địa chỉ Email *</label><br>
                            <input type="email" name="w_email" class="form-control" id="dk_email" aria-describedby="emailHelp" placeholder="Nhập địa chỉ email" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Số điện thoại *</label><br>
                            <input type="number" name="w_phone" class="form-control" id="dk_sdt" placeholder="Nhập số điện thoại" required>
                        </div>
                        <div class="form-group">
...
<div class="social-btn" style="position: fixed; left: 10px; bottom: 10px; width: 60px; opacity: 1;">
	<a title="Zalo" href="https://chat.zalo.me/?phone=84927151535"><img src="https://cdn.autoads.asia/content/images/widget_icon_zalo.svg"></a>
	<a title="Messenger" href="https://www.messenger.com/t/100910621259961"><img src="https://cdn.autoads.asia/content/images/widget_icon_messenger.svg" alt=""></a>
	<a title="Call" href="tel:0927151535"><img src="https://cdn.autoads.asia/content/images/widget_icon_click_to_call.svg" alt=""></a>
	<a title="Mail" href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJfttlCVNfsPNXVcdmVtLLPnShVsZKwrQljBKPttqdMjszWHlmbQkmGwqkNhJmSjpQNtfsB"><img src="http://cdn.autoads.asia/content/images/widget_icon_contact_form.svg" alt=""></a>
</div>
