...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="admins/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    ...
    {{-- tag --}}
    <link rel="stylesheet" type="text/css" href="tag/dist/jquery-tagsinput.min.css"/>
    <script src="tag/dist/jquery-tagsinput.min.js" defer></script>
    {{-- endtag --}}
</head>
...
<script src="admins/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="admins/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<script>
    $(function () {
        $('#example1').DataTable();
        $('#example3').DataTable();
